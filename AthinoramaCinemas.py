"""Get all the Cinemas in Athens from Athinorama Website using Selenium & BeautifulSoup"""
...
for i in web_address:
    address = i
    url = f'https://www.athinorama.gr/cinema/halls/{address}'
...
# df.to_csv("C:/___your_path_here___/Cinemas.csv")